...
class FeatureFusionNetwork(nn.Module):
    ...
    def forward(self, src_temp, src_search, pos_temp, pos_search):
        src_temp = reshapefun(src_temp)
        pos_temp = reshapefun(pos_temp)
        search_shape = src_search.shape
        src_search = reshapefun(src_search)
        pos_search = reshapefun(pos_search)
...
class Encoder(nn.Module):
    ...
    def forward(self, src1, src2,
        ...
        output1 = src1 #Template
        output2 = src2 #search region
