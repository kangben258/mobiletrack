...
def mobilenetv3_small(output_layers=None, pretrained=False, frozen_layers=None):
    model = mobilenetv3()
    return model
def mobilenetv3(**kwargs):
    ...
    # weights = "/home/kb/opencv_lighttrack/Stark/lib/pretrained/mobilenetv3_small_1.0.pth"
    model = MobileNetV3(cfgs, mode='small', used_layers=[4])
