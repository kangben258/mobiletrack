...
class Quantize:
    def __init__(self, model_path, calibration_image_dir, transforms=Tracking(size=128,convert_type="backbone"), convert_type="backbone",net_path="..",per_channel=False, act_type='int8', wt_type='int8', data_dim='chw'):
    ...
    def run(self):
        ...
        quantize_static(new_model_path, output_name, self.dr,
                        ...
                        nodes_to_quantize=['Conv_15', 'Conv_16', 'Conv_18', 'Conv_20', 'Conv_21', 'Conv_23',
                         'Conv_25', 'Conv_27', 'Conv_30', 'Conv_41', 'Conv_42', 'Conv_56', 'Conv_58',
                         'Conv_61', 'Conv_72', 'Conv_74', 'Conv_88', 'Conv_89', 'Conv_92', 'Conv_103'])
...
models_backbone=dict(
    mobiletrack_backbone=Quantize(model_path='/media/kb/2T5/hcat/HCAT/pysot_toolkit/models/mobiletrack/back_cov.onnx',
